...
import { VoiceRecorderButton } from "../ui/voice-recorder-button";
...
export function Thread() {
  ...
  const handleVoiceRecordingComplete = async (audioBlob: Blob) => {
    ...
    try {
      // Show processing state in the input
      setInput("🎤 Processing voice message...");
      ...
      // Save audio locally for testing
      const timestamp = new Date().toISOString().replace(/[:.]/g, '-');
      const fileName = `recorded-audio-${timestamp}.${audioBlob.type.includes('wav') ? 'wav' : 'webm'}`;
      ...
      // Show user where file will be saved
      ...
      toast.info(`Audio saved to Downloads folder`, {
      ...
      console.log(`🔄 Converting blob to base64 for transmission...`);
      ...
      toast.success("Voice message sent!", {
        description: `Processing speech to text... (Saved as ${fileName})`,
      });
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {stream.isLoading ? (
                          ...
                          <Button
                            ...
                            disabled={isLoading || !input.trim() || isProcessingVoice}
                          >
                            {isProcessingVoice ? (
                              <>
